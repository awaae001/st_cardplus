    ...
    <div class="space-y-5">
      ...
      <el-form :model="localForm" label-position="top" class="space-y-4">
        <el-form-item class="mb-0">
          <template #label
            ><span class="form-label-adv">喜欢的事物 / 人</span></template
          >
          <el-input
        ...
        <el-form-item class="mb-0">
          <template #label
            ><span class="form-label-adv">厌恶的事物 / 人</span></template
          >
          <el-input
    ...
    <div class="space-y-5">
      ...
      >
        ...
        >
          ...
          <el-form-item class="mb-0">
            <template #label
              ><span class="form-label-adv">上午 (Morning)</span></template
            >
            <el-input
          ...
          <el-form-item class="mb-0">
            <template #label
              ><span class="form-label-adv">下午 (Afternoon)</span></template
            >
            <el-input
          ...
          <el-form-item class="mb-0">
            <template #label
              ><span class="form-label-adv">傍晚 (Evening)</span></template
            >
            <el-input
          ...
          <el-form-item class="mb-0">
            <template #label
              ><span class="form-label-adv">夜间 (Night)</span></template
            >
            <el-input
          ...
          <el-form-item class="mb-0">
            <template #label
              ><span class="form-label-adv">深夜 (Late Night)</span></template
            >
            <el-input
...
// 本地响应式副本
const localForm = ref<LikesDislikesRoutineForm>(
