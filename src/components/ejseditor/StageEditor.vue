  ...
  <div class="stage-editor">
    ...
    <div class="form-item">
      ...
      <div class="condition-groups-container">
        <div
          v-for="(group, groupIndex) in stage.conditionGroups"
          :key="group.id"
        ...
        >
          <div class="condition-group-header">
            ...
            <el-button
              v-if="stage.conditionGroups.length > 1"
              type="danger"
              :icon="Delete"
              circle
              size="small"
          ...
          >
            <el-tooltip
              ...
              :content="condition.variablePath"
              placement="top"
              :enterable="false"
            >
            ...
            <el-select
              ...
              placeholder="选择变量"
              :style="isMobile ? 'width: 100%; margin-bottom: 8px;' : 'width: 150px'"
              filterable
            >
              <el-option
            ...
            <div
              class="condition-row"
              :class="{ 'mobile-condition-row': isMobile }"
            >
              <el-select
          ...
          <div
            v-if="groupIndex < stage.conditionGroups.length - 1"
    ...
    <div class="form-item">
      <label>
        阶段内容
        <el-tooltip
          content="支持YAML格式，内容将被嵌入到EJS模板中"
          placement="top"
        >
