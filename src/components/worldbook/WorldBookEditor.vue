          ...
          <h3 class="form-section-title">
            ...
            <div class="entry-navigation-buttons">
              <el-button
                ...
                :disabled="props.currentEntryIndex <= 0 && !props.isPreviousEntryInDifferentBook"
                size="small"
              >
          ...
          <div class="form-section-content">
            <div class="form-row-responsive">
              ...
              <div class="form-group-responsive">
                ...
                >
                  <el-option
                    v-for="item in props.allKeywords"
                    :key="item"
                    :label="item"
                    :value="item"
                  />
          ...
          <div class="form-grid-3-col">
            ...
            <div class="form-grid-span-3">
              ...
              <div class="form-flex-row">
                <el-slider
                  v-model="localModel.probability"
                  :min="0"
                  :max="100"
                  show-input
                  class="form-slider"
                ...
                />
                <el-checkbox
                  v-model="localModel.useProbability"
                  label="启用概率"
            ...
            <div v-if="localModel.position === 7">
              ...
              <el-input
                v-model="localModel.outletName"
                placeholder="指定一个或多个出口名称,用逗号分隔"
              />
            </div>
            <div>
              <label class="form-label">插入深度 (Depth)</label>
              <el-input-number
                v-model="localModel.depth"
                :min="0"
                :max="999"
                controls-position="right"
                class="form-full-width"
                :disabled="localModel.position !== 4"
              />
            </div>
          </div>
        </section>
          ...
          <div v-show="advancedOptionsVisible">
            <section class="form-section">
              ...
              <div class="form-grid-3-col-top-align">
                <div class="form-flex-col-start">
                  ...
                  <el-switch
                    :model-value="!!localModel.caseSensitive"
                ...
                <div class="form-flex-col-start">
                  ...
                  <el-switch
                    :model-value="!!localModel.matchWholeWords"
                ...
                <div>
                  ...
                  <el-select
                    v-model="localModel.selectiveLogic"
                    placeholder="选择逻辑"
                    class="form-full-width"
            ...
            <section class="form-section">
              ...
              <div class="form-grid-3-col-top-align">
                <div class="form-grid-span-3">
                  ...
                  <div class="form-grid-3-col">
                    <el-checkbox
                      v-model="localModel.matchPersonaDescription"
                      label="用户人设"
                    />
                    <el-checkbox
                      v-model="localModel.matchCharacterDescription"
                      label="角色描述"
                    />
                    <el-checkbox
                      v-model="localModel.matchCharacterPersonality"
                      label="角色性格"
                    />
                    <el-checkbox
                      v-model="localModel.matchCharacterDepthPrompt"
                      label="角色笔记"
                    />
                    <el-checkbox
                      v-model="localModel.matchScenario"
                      label="场景设定"
                    />
                    <el-checkbox
                      v-model="localModel.matchCreatorNotes"
                      label="创作者备注"
                    />
                  </div>
            ...
            <section class="form-section">
              ...
              <div class="form-grid-3-col-top-align">
                ...
                <div>
                  ...
                  <el-input-number
                    v-model="localModel.groupPriority"
                    controls-position="right"
                    class="form-full-width"
                  />
                </div>
                ...
                <div class="form-flex-col-start">
                  ...
                  <el-switch
                    :model-value="!!localModel.useGroupScoring"
            ...
            <section class="form-section">
              ...
              <div>
                ...
                <el-input
                  v-model="localModel.automationId"
