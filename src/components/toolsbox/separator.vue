<template>
  <div class="image-parser-page p-3 md:p-5 h-full flex flex-col">
    <header
      class="flex flex-col sm:flex-row justify-between items-center mb-4 md:mb-6 flex-shrink-0 gap-y-3"
    >
      <div class="flex items-center gap-3">
        <button
          @click="$router.push('/toolbox')"
          class="btn-secondary-adv !py-1.5 !px-3 text-sm"
        >
    ...
    <el-alert
      title="解析角色卡图片内嵌的JSON元数据并支持本地保存。"
      type="info"
      :closable="false"
      class="mb-4 md:mb-6 flex-shrink-0"
    />
    ...
    <div class="content-panel flex-grow flex flex-col min-h-0">
      ...
      <div
        class="content-panel-body flex-grow flex flex-col md:flex-row gap-4 md:gap-6"
      >
        <div class="w-full md:w-1/3">
          ...
          >
            <div
              class="el-upload__icon text-6xl text-neutral-400 dark:text-neutral-500"
            >
              <Icon icon="ph:upload-simple-duotone" />
            </div>
            <div class="el-upload__text text-neutral-600 dark:text-neutral-300">
              将图片拖到此处，或<em>点击上传</em>
            </div>
            <template #tip>
              <div
                class="el-upload__tip text-xs text-neutral-500 dark:text-neutral-400 mt-2"
              >
        ...
        <div
          class="w-full md:w-2/3 flex justify-center items-center bg-neutral-100 dark:bg-neutral-800 rounded-lg min-h-[200px] p-4"
        >
          <el-image
            v-if="imageUrl"
            :src="imageUrl"
    ...
    <div
      class="content-panel mt-4 md:mt-6 flex-shrink-0"
      v-if="parsedData || characterData"
    >
      <div class="content-panel-header">
        <h3 class="content-panel-title flex items-center gap-2">
          <Icon
        ...
        <button
          v-if="characterData"
          @click="saveJson"
          class="btn-primary-adv !py-1.5 !px-3 text-sm"
        >
      ...
      <div class="content-panel-body">
        <el-tabs type="border-card" class="custom-tabs">
          ...
          >
            <div
              class="flex justify-between items-center text-xs text-neutral-500 dark:text-neutral-400 mb-2"
            >
