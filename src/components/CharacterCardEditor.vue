<template>
    <div class="p-4 bg-gray-100 min-h-screen">
      ...
      <!-- 性格特质 -->
      <el-card class="mb-4">
        <h2 class="text-xl font-semibold mb-2">性格特质</h2>
        <div v-for="(trait, index) in form.traits" :key="index" class="mb-4">
          ...
          />
          <el-input
            v-model="trait.dialogueExamples"
            type="textarea"
            :rows="2"
            placeholder="对话示例"
            class="mb-2"
          />
          <el-input
            v-model="trait.behaviorExamples"
            type="textarea"
            :rows="2"
            placeholder="行为示例"
            class="mb-2"
          />
          <el-button type="danger" @click="removeTrait(index)">删除特质</el-button>
        </div>
        <el-button type="primary" @click="addTrait">+ 添加特质</el-button>
      </el-card>
  
      <!-- 人际关系 -->
      <el-card class="mb-4">
        <h2 class="text-xl font-semibold mb-2">人际关系</h2>
        <div v-for="(relationship, index) in form.relationships" :key="index" class="mb-4">
          ...
          <el-input
            ...
            class="mb-2"
          />
          <el-button type="danger" @click="removeRelationship(index)">删除关系</el-button>
        </div>
